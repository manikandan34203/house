            ...
            <div className='cbe-body'>
                <div className='coimbatore-page'>
                    <header className='header1'>
                        <h1>Independent Houses for Rent in Coimbatore</h1>
                    </header>
