...
const Propertydetailsche = () => {
    ...
    const handleBookNow = () => {
        navigate('/charges-to-pay', { state: { plan: 'essential' } }); // Pass the plan or any other state needed
    };
            ...
            <div id="rent" className="rent-depositpd">
                <div className="detailspd">
                    <div className="headerpd">
                        <h2>Rent & Deposit</h2>
                        <button className="button-86" onClick={handleBookNow}>BOOK NOW</button> {/* Updated button handler */}
                    </div>
...
export default Propertydetailsche;
