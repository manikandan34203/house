...
import propertiesche from './Propertiesbgr.js'; // Import properties array
...
const Propertydetailsbgr = () => {
    ...
    const handleBookNow = () => {
        navigate('/charges-to-pay', { state: { plan: 'bgr' } }); // Replace 'bgr' with the actual plan if necessary
    };
            ...
            <div id="rent" className="rent-depositpd">
                <div className="detailspd">
                    <div className="headerpd">
                        <h2>Rent & Deposit</h2>
                        <button className="button-86" onClick={handleBookNow}>BOOK NOW</button>
                    </div>
...
export default Propertydetailsbgr;
